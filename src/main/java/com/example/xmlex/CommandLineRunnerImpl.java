...
public class CommandLineRunnerImpl implements CommandLineRunner {
    ...
    private final String RESOURCES_FILE_PATH = "src/main/resources/files/";
    private final String OUT_FILE_PATH = "out/";
    ...
    private final String PRODUCTS_IN_RANGE_FILE_NAME = "products-in-range.xml";
    private final String SOLD_PRODUCTS_FILE_NAME = "sold-products.xml";
    ...
    private void successfullySoldProducts() throws JAXBException {
        ...
        xmlParser.writeToFile(RESOURCES_FILE_PATH + OUT_FILE_PATH + SOLD_PRODUCTS_FILE_NAME,
                userViewRootDto);
    }
    ...
    private void productsInRange() throws JAXBException {
        ...
        ProductViewRootDto rootDto = productService
                .findProductInRangeWithoutBayer();

        xmlParser.writeToFile(RESOURCES_FILE_PATH + OUT_FILE_PATH + PRODUCTS_IN_RANGE_FILE_NAME,
                rootDto);
    }
